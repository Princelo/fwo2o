...
class youhuiModule extends MainBaseModule
{
    ...
    public function index(){
        ...
        //获取支持门店数据
        $supplier_locations = $GLOBALS['db']->getAll("select sl.id,sl.name,sl.address,sl.tel from ".DB_PREFIX."youhui_location_link as yll left join ".DB_PREFIX."supplier_location as sl on sl.id = yll.location_id where yll.youhui_id = ".$data_id);
        /*点评数据*/
